...
export default function DashboardPage() {
  ...
  const stats = [
    ...
    },
    {
      ...
      subtitle: `${(overviewData?.activity?.error_rate || 0).toFixed(1)}% error rate`,
      icon: Activity,
    ...
    <AppLayout>
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-zinc-500 mt-1">Real-time overview of your agent ecosystem</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card>
            <CardHeader title="Activity (24h)" description="Requests and errors per hour" />
            <div className="h-64">
          ...
          {/* Top Agents Chart */}
          <Card>
            <CardHeader title="Top Agents" description="Most active agents today" />
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={(metricsData?.top_agents || []).slice(0, 5)} layout="vertical">
                  ...
                  <Tooltip
                    contentStyle={{ backgroundColor: "#18181b", border: "1px solid #3f3f46", borderRadius: "8px" }}
                  />
                  <Bar dataKey="request_count" fill="#6366f1" radius={[0, 4, 4, 0]} name="Requests" />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </Card>
        ...
        {/* Recent Activity */}
        <Card>
          <CardHeader title="Recent Activity" description="Latest actions across all agents" />
